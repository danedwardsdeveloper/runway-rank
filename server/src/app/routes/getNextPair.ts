...
const getNextPairRoute = express.Router();

getNextPairRoute.post('/', async (req: CustomRequest, res: Response) => {
	logger.info('Received request at /api/get-next-pair');
	try {
...
export default getNextPairRoute as Router;
