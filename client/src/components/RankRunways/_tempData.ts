	...
	nextPair: [
		{
			...
			name: 'Snatch Game',
			queenName: 'Jinkx Monsoon',
			franchise: "RuPaul's Drag Race",
			season: 5,
			episode: 5,
			episodeName: 'Snatch Game',
			score: 1978,
			ratingsCount: 47,
			imageSlug: 'https://example.com/images/jinkx_snatch_game.jpg',
		},
		{
			...
			season: 4,
			episode: 1,
			episodeName: 'RuPocalypse Now!',
			score: 1865,
			ratingsCount: 47,
			imageSlug: 'https://example.com/images/sharon_drag_on_a_dime.jpg',
		},
	],
};
